...
class ChatBot {
    ...
    initializeResponses() {
        ...
        return {
            // Saudações
            saudacoes: [
                'olá', 'oi', 'bom dia', 'boa tarde', 'boa noite', 'heo', 'hello'
            ],
            respostas_saudacao: [
            ...
            resposta_contato: `📞 <strong>Entre em contato conosco:</strong><br>
                Telefone: (509) 3414-0941 <br>
                WhatsApp: (45)97400-2054 <br>
            ...
            resposta_localizacao: `📍 <strong>Nossa localização:</strong><br>
                Rua Selvino Casagrande, 123<br>
                Centro - CASCAVEL PR/UF<br>
                CEP: 85805-280<br><br>
